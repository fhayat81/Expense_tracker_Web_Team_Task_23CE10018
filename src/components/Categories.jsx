        ...
        <div className="bg-white rounded-lg drop-shadow-lg w-[300px] sm:w-[700px] my-3">
          ...
          <div className="sm:grid grid-cols-2">
            {income.map((data) => (
              <div
                key={data.id}
                className="my-1 mx-3 flex items-center w-[280px] justify-between relative"
              >
                ...
                <div className="group relative">
                  ...
                  <div className="hidden group-hover:block absolute right-0 z-50 bg-slate-200 rounded-lg border-2 border-black -translate-y-12">
                    <p
                      onClick={() => {
                        editCategoryPopUp(data, "Income");
                      }}
                      className="my-1 hover:bg-slate-500 cursor-pointer px-2 mx-1 hover:text-white rounded-lg active:scale-95"
                    >
                      Edit
                    </p>
                    <div className="mx-1 h-[1px] bg-gray-500 rounded-lg"></div>
                    <p
                      onClick={() => {
                        deleteCategory(data.id, "Income");
                      }}
                      className="my-1 hover:bg-slate-500 cursor-pointer px-2 mx-1 hover:text-white rounded-lg active:scale-95"
                    >
                      Delete
              ...
              >
                ...
                <div className="group relative">
                  ...
                  <div className="hidden group-hover:block absolute right-0 z-50 bg-slate-200 rounded-lg border-2 border-black -translate-y-12">
                    <p
                      onClick={() => {
                        editCategoryPopUp(data, "Expense");
                      }}
                      className="my-1 hover:bg-slate-500 cursor-pointer px-2 mx-1 hover:text-white rounded-lg active:scale-95"
                    >
                      Edit
                    ...
                    <p
                      onClick={() => {
                        deleteCategory(data.id, data.val, "Expense");
                      }}
                      className="my-1 hover:bg-slate-500 cursor-pointer px-2 mx-1 hover:text-white rounded-lg active:scale-95"
                    >
                      Delete
