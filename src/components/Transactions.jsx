  ...
  return (
    <div className="my-3 mx-4">
      <div className="flex flex-col items-center justify-center ">
        ...
        <div className="bg-white rounded-lg drop-shadow-lg w-[300px] sm:w-[600px]">
          ...
          <div className="my-2 mx-2">
            ...
            <div className="flex justify-center items-center">
              <button
                onClick={() => {
                  newTransaction(title, amount, category, note, type);
                  setTitle("Untitled")
                  setAmount(0);
                  setCategory(incomeCategory);
                  setNote("");
        ...
        <div className="my-1">
          {record.length !== 0 && 
          record.slice().reverse().map((data)=>(
            <div key={data.id} className="bg-white rounded-lg drop-shadow-lg w-[300px] sm:w-[600px]">
            <div className="bg-slate-300 rounded-t-lg">
              <h1 className="mx-2 my-1 text-lg font-semibold flex justify-between items-center">
                ...
                <div onClick={()=>{deleteTransaction(data)}} className="bg-red-500 text-white rounded-lg m-1 active:scale-95">
            ...
            <div className="mx-2 my-1">
              <div className="flex justify-between items-center">
                ...
                {data.type === "Income" && <h1 className="text-3xl mx-1 text-green-500 text-right"> +{data.amount}</h1>}
                {data.type === "Expense" && <h1 className="text-3xl mx-1 text-red-500 text-right"> -{data.amount}</h1>}
              </div>
